...
func (s *legalizationStage) Name() string                   { return backend.DefaultStageOrder[3] }
...
func init() {
	backend.RegisterStage(backend.DefaultStageOrder[3], func() backend.Stage { return &legalizationStage{} })
}
