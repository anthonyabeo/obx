...
func (s *assemblyStage) Name() string                   { return backend.DefaultStageOrder[6] }
...
func init() {
	backend.RegisterStage(backend.DefaultStageOrder[6], func() backend.Stage { return &assemblyStage{} })
}
