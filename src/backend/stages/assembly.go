...
func (s *assemblyStage) Name() string                   { return backend.DefaultStageOrder[4] }
...
func init() {
	backend.RegisterStage(backend.DefaultStageOrder[4], func() backend.Stage { return &assemblyStage{} })
}
