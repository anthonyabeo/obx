...
func (s *linkingStage) Name() string                   { return backend.DefaultStageOrder[7] }
...
func init() {
	backend.RegisterStage(backend.DefaultStageOrder[7], func() backend.Stage { return &linkingStage{} })
}
