...
func (s *instructionSelectionStage) Name() string               { return backend.DefaultStageOrder[2] }
...
func init() {
	backend.RegisterStage(backend.DefaultStageOrder[2], func() backend.Stage { return &instructionSelectionStage{} })
}
